...
;-------------------------------------------------------------------------------
    ...
    DATA_MONEY_AMOUNT MONEY_0, 0, 0
    DATA_MONEY_AMOUNT MONEY_1, 0, 1
    DATA_MONEY_AMOUNT MONEY_2, 0, 2
    DATA_MONEY_AMOUNT MONEY_5, 0, 5
    DATA_MONEY_AMOUNT MONEY_10, 0, 10
    DATA_MONEY_AMOUNT MONEY_12, 0, 12
    DATA_MONEY_AMOUNT MONEY_14, 0, 14
    DATA_MONEY_AMOUNT MONEY_50, 0, 50
    DATA_MONEY_AMOUNT MONEY_100, 0, 100
    DATA_MONEY_AMOUNT MONEY_500, 0, 500
    DATA_MONEY_AMOUNT MONEY_1000, 0, 1000
    DATA_MONEY_AMOUNT MONEY_3000, 0, 3000
    DATA_MONEY_AMOUNT MONEY_5000, 0, 5000
    DATA_MONEY_AMOUNT MONEY_7000, 0, 7000
    DATA_MONEY_AMOUNT MONEY_10000, 0, 10000
    DATA_MONEY_AMOUNT MONEY_20000, 0, 20000
